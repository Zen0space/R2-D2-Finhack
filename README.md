...
Each member has a hero card under `maji-core/heroes/` that captures their role and signature tools.
...
| Moon | Backend and infra driver | API, schema, migrations, deploy |
