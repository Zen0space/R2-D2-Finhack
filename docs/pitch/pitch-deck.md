...
## Slide 4 — The Test Bed · 25 seconds

**Visual**
- Left half: map of Selangor with NADI Felda Gedangsa pinned (Hulu Selangor district)
- Right half: details about the test bed

**Headline** (Cormorant Garamond 40pt)
> Why NADI Felda Gedangsa.

**Stats** (Inter 18pt)
- **Felda settlement** — primarily oil-palm + rubber smallholders
- **Communal management tradition** — Felda model is collective by design
- **MCMC-run NADI centre** — already serves the kampung with digital training, light banking, courier service
- **B40 concentrated** — Felda smallholders predominantly in B40 income bracket
- **1.5h drive from FINHACK venue** — site visit feasibility for Day 2 follow-up

**Closing line** (Cormorant Garamond italic 22pt, maroon, centered)
> Real institutions. Real settlement. Real B40 household pool dynamics — not synthetic.

---

## Slide 5 — The Demo · 70 seconds
